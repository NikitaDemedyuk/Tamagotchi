                      ...
                      child: Stack(
                        ...
                        children: <Widget>[
                          ...
                          Align(
                            ...
                            child: buttonActionOnImage(Colors.red, 120, 0.01, 2, 3),
                          ),
                          Align(
                            alignment: Alignment.centerRight,
                            child: buttonActionOnImage(Colors.green, 60, 0.01, 2, 1),
                          ),
                          Align(
                            alignment: Alignment.center,
                            child: buttonActionOnImage(Colors.amber, 100, 0.01, 2, 2),
                          ),
                          Align(
                            alignment: Alignment.topRight,
                            child: buttonActionOnImage(Colors.green, 70, 0.01, 2, 1),
                          ),
                          Align(
                          ...
                          Align(
                            ...
                            child: buttonActionOnImage(Colors.red, 110, 0.01, 2, 3),
                          ),
                        ],
                      ),
                    ),
